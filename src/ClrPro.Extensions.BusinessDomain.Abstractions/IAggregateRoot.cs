...
namespace ClrPro.Extensions.BusinessDomain
{
    ...
    /// <summary>
    ///     The non-generic business domain aggregate root.(forbidding external objects from holding references to its
    ///     members).
    /// </summary>
    /// <remarks>
    ...
    [SuppressMessage(
        ...
        Justification = "Non-generic form could be helpful to form self-expressing collections.")]
    [PublicAPI]
